...
import {
  clientReviewFirstCol,
  clientReviewSecondCol,
  clientReviewThirdCol,
  clientsReviews,
} from '~/constants'
      ...
      <div className="mt-[50px] px-0 md:px-[33px] lg:px-0">
        ...
        <div className="relative hidden h-[654px] w-full flex-row items-center justify-center overflow-hidden lg:flex">
          ...
          <Marquee
            ...
            pauseOnHover
            vertical
            className="[--duration:10s] lg:flex md:flex hidden"
          >
          ...
          <Marquee
            pauseOnHover
            vertical
            className="[--duration:10s] lg:flex hidden"
          >
        ...
        <div className="relative md:flex lg:hidden hidden h-[654px] w-full flex-row items-center justify-center overflow-hidden">
          ...
          <Marquee
            ...
            pauseOnHover
            vertical
            className="[--duration:15s] lg:flex md:flex hidden"
          >
