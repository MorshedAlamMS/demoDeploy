  ...
  return (
    <section className="lg:pt-[100px] pt-[90px] pb-[60px]">
      ...
      <div className="lg:mt-[80px] mt-[50px]">
        ...
        <Link
          to="/portfolio"
          className="w-fit flex flex-col items-center justify-center mx-auto lg:mt-[80px] mt-[50px] px-5 h-[46px] font-bold font-gabarito bg-brand-parrot text-primary-text rounded-[10px] hover:rounded-xl text-base transition-all duration-200 ease-in transform hover:scale-95"
        >
          Show All
        </Link>
      </div>
