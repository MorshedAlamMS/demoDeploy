...
const MyStrategy = () => {
    return (
        <section className="w-full lg:max-w-[1024px] md:max-w-[768px] pb-10 pt-[80px] px-[13px] md:px-[33px] lg:px-0 flex flex-col items-center mx-auto">
            ...
            <p className="lg:max-w-[776px] md:max-w-[702px] max-w-[349px] leading-[160%] text-xl text-tertiary-text text-center font-medium font-bricolage pt-10 pb-20">{myStrategySectionTopDescription}</p>
            {/* cards */}
            ...
            <p className="md:max-w-[724px] max-w-[349px] leading-[160%] text-xl text-tertiary-text text-center font-medium font-bricolage pt-10 pb-20">{myStrategySectionBottomDescription}</p>

            <p className="md:max-w-[636px] max-w-[349px] text-[30px] leading-[140%] text-[rgba(0,0,0,0.75)] font-bold font-bricolage text-center">{myStrategySectionBottomTitle}</p>
        </section>
    );
};
